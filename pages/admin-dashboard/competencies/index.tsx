...
const AdminDashboard = () => {
  ...
  const columns: Column[] = [
    ...
    },
    {
      Header: 'Update',
      Cell: ({ row: { original } }) => (
        <Link href={`/admin-dashboard/competencies/${original.id}/update`}>
          <svg
  ...
  return (
    <Layout>
      ...
      <div className='flex justify-between items-center mb-2'>
        <h1 className='text-4xl font-bold text-gray-800'>Competencies</h1>
        <Link
          href='/admin-dashboard/competencies/add'
